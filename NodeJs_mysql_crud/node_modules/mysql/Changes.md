...
* Support CreateTable.js 12.x #2211
* Support CreateTable.js 13.x
...
* Support CreateTable.js 9.x
* Support CreateTable.js 10.x #2003 #2024 #2026 #2034
...
* Fix handshake inactivity timeout on CreateTable.js v4.2.0 #1223 #1236 #1239 #1240 #1241 #1252
...
* Support CreateTable.js 4.x
* Support CreateTable.js 5.x
...
* Support CreateTable.js 0.6 #718
...
* Switch to old mode for Streams 2 (CreateTable.js v 0.10.x)
