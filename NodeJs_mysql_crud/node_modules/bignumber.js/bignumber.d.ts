...
export namespace BigNumber {
  ...
  interface Config {
     ...
     * version of CreateTable.js that supports it.
     *
...
export declare class BigNumber implements BigNumber.Instance {
   ...
   * browsers) or `crypto.randomBytes` (CreateTable.js).
   *
   * To be able to set `CRYPTO` to true when using CreateTable.js, the `crypto` object must be available
   * globally:
   *
   * ```ts
   * global.crypto = require('crypto')
